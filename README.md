...
An MCP server that gives AI agents structured access to **32 tools** across
...
| Doc | What it covers |
|---|---|
| **[docs/tools.md](docs/tools.md)** | Full catalog of all 32 tools grouped by category, input fields, and use cases |
...
32 tools across 24 data sources (plus local RDKit cheminformatics), organized into 9 categories. Full details
...
| **Druggability** | `get_compounds`, `compute_molecular_properties`, `get_chembl_compounds` | PubChem, RDKit, ChEMBL |
